    ...
    <div class="col-md-10">
        <div class="row">
         ...
         <!--                    <th>ID Kelas</th> -->
                            ...
                            include 'koneksi.php';
                            $no=1;
                            $sql='SELECT kelas.id,kelas.nm_kelas,kelas.tingkat,kelas.id_jur,jurusan.nm_jur,jurusan.kaprog FROM kelas INNER JOIN jurusan ON kelas.id_jur=jurusan.id_jur';
                            ...
                            echo "<tr>";
                                echo "<td>".$no++."</td>";
                                // echo "<td>".$row['id']."</td>";
                                echo "<td>".$row['nm_kelas']."</td>";
                                echo "<td>".$row['nm_jur']."</td>";
                                echo "<td>".$row['tingkat']."</td>";
                                echo "<td>";
                                echo "<a href=up_kls.php?id=".$row['id'].">Edit</a> | ";
                                echo "<a href=cetak_kls.php?id=".$row['id'].">Cetak</a> | ";
                                echo "<a href=del_kls.php?id=".$row['id'].">Hapus </a>";
                                echo "</td>";        
                            echo "</tr>";
                            }
                            ?>
